...
1. Clone this repo using `https://github.com/Vardan26/react-starter.git`
2. Move to the appropriate directory: `cd react-starter`.<br />
...
MIT license, Copyright (c) 2019 Vardan Shahbazyan
